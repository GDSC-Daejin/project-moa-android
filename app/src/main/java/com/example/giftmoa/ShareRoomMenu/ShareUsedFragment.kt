...
import com.example.giftmoa.databinding.FragmentShareUsedBinding
 ...
 * Use the [ShareUsedFragment.newInstance] factory method to
 * create an instance of this fragment.
 */
class ShareUsedFragment : Fragment() {
    ...
    private val TAG = "ShareUsedFragment"
    ...
    override fun onCreateView(
        ...
        val usedCouponList = teamGifticonViewModel.usedCouponList.value

        Log.d(TAG, "usedCouponList: $usedCouponList")
        ...
        }, usedCouponList ?: emptyList<TeamGifticon>())
    ...
    companion object {
         ...
         * @return A new instance of fragment ShareUsedFragment.
         */
        // TODO: Rename and change types and number of parameters
        @JvmStatic
        fun newInstance(param1: String, param2: String) =
            ShareUsedFragment().apply {
